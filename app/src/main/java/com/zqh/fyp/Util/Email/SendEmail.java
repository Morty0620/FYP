...
//    public static String myEmailPassword = "oqivsakcubrdbcbg";
    ...
    public static String myEmailAccount = QQInfo.myEmailAccount;
    public static String myEmailPassword = QQInfo.myEmailPassword;
    ...
    public static void send(String receiveMailAccount) throws Exception {
        ...
        final String smtpPort = QQInfo.sslPort;
